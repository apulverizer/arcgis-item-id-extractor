...
function copyItemId(info, tab) {
    ...
    else if (info.linkUrl.includes('/workforce/')){
      copyTextToClipboard(getWorkforceId(info.linkUrl));
    }
    else{
  ...
  function getWorkforceId(url){
      return url.split("/").slice(-3,-2);
  }
